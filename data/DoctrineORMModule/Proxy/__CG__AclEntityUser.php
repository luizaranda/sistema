...
class User extends \Acl\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Acl\\Entity\\User' . "\0" . 'id', '' . "\0" . 'Acl\\Entity\\User' . "\0" . 'role', '' . "\0" . 'Acl\\Entity\\User' . "\0" . 'name', '' . "\0" . 'Acl\\Entity\\User' . "\0" . 'email', '' . "\0" . 'Acl\\Entity\\User' . "\0" . 'password', '' . "\0" . 'Acl\\Entity\\User' . "\0" . 'salt', '' . "\0" . 'Acl\\Entity\\User' . "\0" . 'active', '' . "\0" . 'Acl\\Entity\\User' . "\0" . 'activationKey', '' . "\0" . 'Acl\\Entity\\User' . "\0" . 'createdAt', '' . "\0" . 'Acl\\Entity\\User' . "\0" . 'updatedAt'];
        }
